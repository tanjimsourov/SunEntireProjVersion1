                        ...
                        <div className="box box-shadow light">
                            ...
                            <div className="wrap">
                                <div className="wrapper">
                                    <h3 >This installation currently supplies enough green electricity for 11,246 households.</h3>
                                    <div className="row">
                                        <div className="col-xs-12 col-sm-6">
                                            <h4 style={{fontWeight: 500}} class="mt-4 vh4">The current solar energy production of 1,972.05 kWh is equal to the electricity consumption of 11,246 3-person households.</h4>
                                        </div>
                                        <div className="col-xs-12 col-sm-6">
