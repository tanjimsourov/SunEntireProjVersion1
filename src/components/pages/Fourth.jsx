                            ...
                            <div className="wrap">
                                <div className="row">
                                    <div className="col-xs-12 col-sm-6">
                                        <h3 className='mb-3 vh3'>Total amount of CO&#8322; saved: 319 t</h3>
                                        <p  class="m-0 p-0">25,491 trees would have to be planted to remove the same amount of CO&#8322; from the air in 10 years.</p>
                                    </div>
